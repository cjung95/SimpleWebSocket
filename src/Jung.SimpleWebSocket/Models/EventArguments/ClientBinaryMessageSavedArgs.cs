...
namespace Jung.SimpleWebSocket.Models.EventArguments
{
    ...
    /// </param>
    /// <param name="clientId">The id of the client sending this message</param>
    ...
    public sealed class ClientBinaryMessageSavedArgs(Stream stream, long length, string tempFilePath, Func<ValueTask> completeProcessingAsync, string clientId)
    {
        /// <summary>
        ...
        /// <summary>
        /// The unique identifier of the client sending this message.
        /// </summary>
